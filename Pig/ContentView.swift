...
//  Pig
//
//  Created by Andrew Castillo Nevarez on 11/16/22.
//
        ...
        ZStack {
            ...
            VStack {
                ...
                VStack (alignment: .leading){
                    Text("In the game Pig, players take individual turns. Each turn, a player repeatedly rolls a single die until either a pig is rolled or the player decides to \"hold\".")
                        .padding()
                    Text("If the player rolls a pig, they score nothing, and it becomes the next player's turn.")
                        .padding()
                    Text("If the player rolls any other number, it is added to their total, and the player's turn continues.")
                        .padding()
                    Text("If a player \"hold\", their turn total is added to their game score, and it becomes the next player's turn.")
                        .padding()
